...
The IBI calibration project resulted in two indices applicable in two stream types that varied by the concentration of natural lithologic nitrogen (as estimated by USGS StreamCat). Each stream type was separated into two site classes, HiN and LoN, and an index was developed for both.Reports detailing the development of the diatom IBIs can be found [here](https://github.com/Blocktt/IDEMtools/tree/main/reports).
